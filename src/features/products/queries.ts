...
export const PRODUCT_COLUMNS =
  'id,organization_id,sku,name,description,category,unit_of_measure,cost_price,sale_price,image_url,reorder_level,is_active,visible_on_landing_page,created_at,updated_at,deleted_at,created_by' as const;
