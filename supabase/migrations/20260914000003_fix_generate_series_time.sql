-- ============================================================================
-- FIX get_available_slots: generate_series with TIME
-- ============================================================================
-- The generate_series function doesn't support TIME types directly.
-- We need to convert TIME to TIMESTAMP, generate the series, then extract TIME.
-- ============================================================================
